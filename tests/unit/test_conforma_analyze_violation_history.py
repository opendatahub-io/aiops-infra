    ...
    def test_not_present_with_timeline(self):
        data = {
            ...
            "timeline": [
                ...
                {"sha": "def456", "date": "2026-05-01T00:00:00Z", "present": True, "count": 2, "components": ["comp-a"]},
                {"sha": "jkl012", "date": "2026-04-01T00:00:00Z", "present": True, "count": 1, "components": ["comp-a"]},
            ],
        }
        text = violation_history.format_text(data)
...
class TestTraceHistory:
    ...
    def test_no_commits_found(self):
        with patch.object(violation_history, "_find_csv_path", return_value="prod/release_day/report.csv"), \
    ...
    def test_basic_trace(self):
        csv_content = (
            "type,component_name,code,message\n"
    ...
    def test_until_found_stops_early(self):
        ...
        with patch.object(violation_history, "_find_csv_path", return_value="report.csv"), \
             patch.object(violation_history, "_fetch_commits", return_value=commits), \
             patch.object(violation_history, "_fetch_csv_content", side_effect=mock_fetch_csv):
            result = violation_history.trace_history(
                "rhoai-3.4", "hermetic_task.hermetic", until_found=True
            )
    ...
    def test_with_csv_path_override(self):
        ...
        with patch.object(violation_history, "_fetch_commits", return_value=commits) as mock_commits, \
             patch.object(violation_history, "_fetch_csv_content", return_value=csv_content):
            result = violation_history.trace_history(
                "rhoai-3.4", "hermetic_task.hermetic",
