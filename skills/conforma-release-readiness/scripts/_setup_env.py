"""Auto-bootstrap for conforma-release-readiness skill scripts.

Adds the repo-root ``scripts/`` directory to ``sys.path`` so that shared
modules (``conforma_context_ops``) can be imported directly.
...
def _find_repo_root() -> Path:
    ...
    Path from this file: scripts/ -> conforma-release-readiness/ -> skills/ -> <repo>/
    """
