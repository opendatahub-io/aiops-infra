...
The original coverage sequence C8–C11 is recorded as completed in its
individual TODO documents. The remaining checkpoints and follow-up design
...
| [C9-renderer-changes.md](C9-renderer-changes.md) | Renderer: Jira block + JIRAs cell + per-row Jira col + pre-fill links | DONE | C8 |
| [C10-workflow-and-docs.md](C10-workflow-and-docs.md) | Workflow Step 8 + SKILL.md + search-conforma-jira-tickets + conforma/TODO.md | DONE | C9 |
| [C11-validation.md](C11-validation.md) | Full validation + pre-commit coverage-gate wiring + live read-only dry-run | DONE, with follow-up gap | C10 |
...
| [C13-independent-conforma-jira-labelling.md](C13-independent-conforma-jira-labelling.md) | Independently label Conforma-related Jira tickets | DONE; broadened by C14 | C11 |
...
| [C15-test-conforma-workdir-isolation.md](C15-test-conforma-workdir-isolation.md) | Isolate Conforma test workdirs from the real home directory | DONE | — |
...
- **C11 follow-up gap** — live validation found that label-first discovery does not find label-less historical ticket RHOAIENG-70681. C13 must resolve this class of gap without weakening deterministic evidence requirements.
