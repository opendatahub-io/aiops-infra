...
```
~/.conforma/bin/conforma_run.sh scripts/conforma_policy_ops.py search-exceptions --rule <rule> --policy-files <file1,file2> [--clone-dir ~/.conforma/konflux-release-data]
```

## Examples

```bash
~/.conforma/bin/conforma_run.sh scripts/conforma_policy_ops.py search-exceptions \
