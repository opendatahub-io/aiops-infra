...
11. ~~ensure the jira coverage can find closed jiras as well - if they relate to a violation/exception in question, e.g.: https://redhat.atlassian.net/browse/RHOAIENG-70681 should be found for~~ — done. Jira: [RHAIENG-6190](https://redhat.atlassian.net/browse/RHAIENG-6190). Plan: `.agents/plans/conforma-analyze-jira-coverage-plan.md`
...
32. **Rework the resolution report into a complete TODO/DONE contract** — in progress. The documentation contract is recorded in [the implementation plan](../../.agents/plans/conforma-todo-and-done-sections-plan.md) and [the conforma-analyze TODO record](../conforma-analyze/todo/resolution-report-todo-done-sections.md). The generated `conforma-todo-and-done.md` preview and full guide must always render the fixed inventory, fail closed on unknown inputs, use stable section markers, and account for each source CSV violation exactly once through an owner section; secondary references do not count again. Python implementation and tests remain outstanding.
