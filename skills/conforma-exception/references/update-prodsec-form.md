...
```bash
~/.conforma/bin/conforma_run.sh skills/conforma-exception/scripts/fill_prodsec_form.py \
...
```bash
~/.conforma/bin/conforma_run.sh skills/conforma-exception/scripts/fill_prodsec_form.py --validate-config
```
...
```bash
~/.conforma/bin/conforma_run.sh skills/conforma-exception/scripts/fill_prodsec_form.py --generate \
