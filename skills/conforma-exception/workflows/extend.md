...
```bash
~/.conforma/bin/conforma_run.sh skills/conforma-exception/scripts/preflight_check.py --check-existing-exception \
  --rule <rule> \
...
```bash
~/.conforma/bin/conforma_run.sh skills/conforma-exception/scripts/preflight_check.py \
  --rhoaieng-url <url> \
