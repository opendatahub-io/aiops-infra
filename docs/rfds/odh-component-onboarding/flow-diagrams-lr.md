...
flowchart LR
    ...
    S1["1. Validate"]:::both
    S2["2. Quay Repo"]:::both
    S3["3. Konflux Release Data"]:::both
    S4["4. Konflux Central"]:::both
    S5["5. ODH Onboarder"]:::odhOnly
    OP{"Operator?"}:::decide
    S6["6. ODH Operator"]:::cond
    S7["7. Bundle Config"]:::both
...
flowchart LR
    ...
    S2["2. Quay Repo"]:::both
    S3["3. Konflux Release Data"]:::both
    S4a["4a. Push Pipelines"]:::both
    S4b["4b. Pull Pipelines"]:::rhoai
    S5["5. Dockerfile Labels"]:::rhoai
    OP{"Operator?"}:::decide
    S6["6. ODH Operator"]:::cond
    S7["7. Bundle Config"]:::both
    S8["8. Delivery Repo"]:::rhoai
    S9["9. Product Listing"]:::rhoai
    S10["10. Auto Merge"]:::rhoai
    S11["11. Renovate and Sync"]:::rhoai
    DONE([Jira to Review]):::done
