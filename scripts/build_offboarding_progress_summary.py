...
Offboarding-specific copy of build_progress_summary.py, decoupled so the onboarding
script is never affected by offboarding pipeline changes.

Usage:
  uv run --script build_offboarding_progress_summary.py \
