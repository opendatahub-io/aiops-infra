#!/usr/bin/env bash
# install.sh — Install the add-component-to-rhoai-konflux-central Claude Code skill
#
# Usage:
...
SKILL_NAME="add-component-to-rhoai-konflux-central"
...
echo ""
echo "    /add-component-to-rhoai-konflux-central https://redhat.atlassian.net/browse/RHOAIENG-1234"
echo ""
