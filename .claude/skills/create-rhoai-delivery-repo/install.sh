#!/usr/bin/env bash
# install.sh — Install the create-rhoai-delivery-repo Claude Code skill
#
# Usage:
...
SKILL_NAME="create-rhoai-delivery-repo"
...
echo ""
echo "    /create-rhoai-delivery-repo https://redhat.atlassian.net/browse/RHOAIENG-1234"
echo ""
