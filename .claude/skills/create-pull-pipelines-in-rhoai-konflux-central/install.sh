#!/usr/bin/env bash
# install.sh — Install the create-pull-pipelines-in-rhoai-konflux-central Claude Code skill
#
# Usage:
...
SKILL_NAME="create-pull-pipelines-in-rhoai-konflux-central"
...
echo ""
echo "    /create-pull-pipelines-in-rhoai-konflux-central https://redhat.atlassian.net/browse/RHOAIENG-1234"
echo ""
