#!/usr/bin/env python3
"""
Wrapper for Konflux Z-Stream Onboard step.

Invokes the konflux_zstream_onboard.py script from rhoai-release-onboarding repository.
...
def main():
    ...
    # Build command
    cmd = [python_cmd, "-m", "src.konflux_zstream_onboard"] + sys.argv[1:]
