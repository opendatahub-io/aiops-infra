#!/usr/bin/env python3
"""
Wrapper for RBC Z-Stream Release step.

Invokes the rbc_zstream_release.py script from rhoai-release-onboarding repository.
...
def main():
    ...
    # Build command
    cmd = [python_cmd, "-m", "src.rbc_zstream_release"] + sys.argv[1:]
